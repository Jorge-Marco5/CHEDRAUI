...
foreach ($ubicaciones as $ubicacion) { ?>
    <div class="containerLocations">
        <h2 class="textLocation">Nombre: <?php echo $ubicacion['nombre']; ?> </h2>
        <h2 class="textLocation">C.P.: <?php echo $ubicacion['C.P.']; ?> </h2>
        <h2 class="textLocation">Calle: <?php echo $ubicacion['calle']; ?> </h2>
        <h2 class="textLocation">Colonia: <?php echo $ubicacion['colonia']; ?> </h2>
        <h2 class="textLocation">Número de Teléfono: <?php echo $ubicacion['numTelefono']; ?> </h2>
        <h2 class="textLocation">Instrucciones de Entrega: <?php echo $ubicacion['instruccionesEntrega']; ?> </h2>
    </div>
    
<?php } ?>

<a href="eliminarUbicacion.php?idUbicacion=<?php echo $ubicacion ['idUbicacion']?>">
...
<?php
    ...
    <form method="post" action="ubicacionQuery.php" name="location-form">
